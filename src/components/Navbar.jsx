      ...
      <div className="container flex items-center justify-between">
        ...
        <div className="flex md:hidden items-center gap-2">
          ...
          <button
            ...
            className="p-2 text-foreground z-50 hover:text-primary transition-colors"
        ...
        <div
          className={cn(
            "fixed inset-0 glass-effect-strong z-40 flex flex-col items-center justify-center",
